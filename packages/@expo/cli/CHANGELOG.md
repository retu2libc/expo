...
- Source platform identity data (known platform names, out-of-tree membership, Apple-family checks, the react-native-tvos package name) from `@expo/platforms` instead of inline lists. No behavior change. ([#49418](https://github.com/expo/expo/pull/49418) by [@douglowder](https://github.com/douglowder))
